...
import ru.sipaha.sawe.app.BuildConfig
 ...
 * [ru.sipaha.sawe.app.ui.workspace.WorkspaceScreen] and the
...
private fun AboutInfo(onOpenGithub: () -> Unit) {
    Column(
        ...
        Text(
            text = "Sawe Mobile · v${BuildConfig.VERSION_NAME} (${BuildConfig.VERSION_CODE})",
            style = MaterialTheme.typography.bodyMedium,
        )
